		...
		do {
			...
			switch(option) {
				...
				case 4:
					...
					break;
				case 5:
					System.out.println("Enter the BookId to be Fetched");
					int bookid = scan.nextInt();
					BookPojo fetchedBook1 = bookService.fetchABook(bookid);
					scan.nextLine();
					System.out.println("Enter Book Price : ");
					int bookPrice1 = scan.nextInt();
					//BookPojo update = bookService.updateBook();
